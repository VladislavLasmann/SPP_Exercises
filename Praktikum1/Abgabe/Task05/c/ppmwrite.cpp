 ...
 * ppmwrite
 */
void _ppmwrite(const char *fname, const field iterations, int maxiter,
...
void ppmwrite(const char *fname, const field iterations, int maxiter )
{
  _ppmwrite( fname, iterations, maxiter, SmoothColorTable(10, fwd, blue, green, red) );
}
